...
ax2.plot(df_temperatura["Data"], df_temperatura["Temp_MM7"], label="Temperatura", color="orange", linestyle="--", linewidth=1.5)

ax1.set_xlabel("Data")
ax1.set_ylabel("Geração de Energia [kWh]")
ax2.set_ylabel("Temperatura (°C)")

ax1.set_title("Geração de Energia x Tempo x Temperatura (Média Móvel 7 dias)")
