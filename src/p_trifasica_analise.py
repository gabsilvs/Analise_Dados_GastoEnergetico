...
def analisar_15_min(df):
    ...
    return ultrapassagem_percentual
...
def exibir_resultados(sheet_name, ultrapassagem, media_diaria, media_mensal, media_fp, perc_fp_baixo):
    print(f"\n{'='*40}")
...
for sheet, df in dataframes.items():
    ultrapassagem = analisar_15_min(df)
    ...
    exibir_resultados(sheet, ultrapassagem, media_diaria, media_mensal, media_fp, perc_fp_baixo)
